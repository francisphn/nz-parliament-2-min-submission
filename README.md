...
In New Zealand, we pride ourselves in having an open and engaging democracy. However, the New Zealand Parliament does not make their API public, which is definitely lacking behind when you compare ourselves to other democratically elected Parliaments.

Think about this scenario. A Bill is passing through Parliament, and it's currently at the Committee stage. You're very passionate about this Bill and submissions from the public are being accepted. So you've put your submission in, but then you also want to run a social media (or physical) campaign to encourage people to put their submissions in, too.
